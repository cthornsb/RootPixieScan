...
DetectorDriver::DetectorDriver() : histo(OFFSET, RANGE) 
{
    ...
    vecProcess.push_back(new VandleProcessor()); //--- Does this (3100-3299)
    ...
    //cout << "VRDet\n";
    vecProcess.push_back(new RootProcessor("tree1.root", "tree")); //--- RootProcessor enqueue, file name, tree name
    //cout << "RPDet\n";
#endif
}
